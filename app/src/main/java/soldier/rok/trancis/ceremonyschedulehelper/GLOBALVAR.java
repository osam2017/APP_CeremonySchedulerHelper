...
public class GLOBALVAR {
    public final static String HOST_SERVER_URL = "http://10.53.128.114:8080";
    public final static String SIGNUP_URL = HOST_SERVER_URL + "/users/signup";
    public final static String SIGNIN_URL = HOST_SERVER_URL + "/users/login";
    public final static String USER_UID_URL = HOST_SERVER_URL + "/users";
